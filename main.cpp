...
/*
  ...
  I regret to say that I wasn't able to create a fully functioning implementation of the StringMap.
  I had major run ins with the copy constructor and the assignment operator. 
  I marked where my implementation is able to pass through the tests until.
...
//This is as far as my implementation is able to get
cout << endl;
cout << "My current implementation has a faulty copy constructor & assignment operator" << endl;
cout << endl;
